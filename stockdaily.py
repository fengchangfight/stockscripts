...
df = pro.daily_basic(ts_code='', trade_date=todayStr,
                     fields='ts_code,trade_date,total_mv,volume_ratio,pe,pb,turnover_rate,close')
...
col_order = ['ts_code', 'name', 'trade_date', 'total_mv',
             'volume_ratio', 'pe', 'pb', 'turnover_rate', 'close']
